...
#if defined(NDEBUG)
# error "Flamecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Flamecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FLA additional fees, %d delta bytes\n",
